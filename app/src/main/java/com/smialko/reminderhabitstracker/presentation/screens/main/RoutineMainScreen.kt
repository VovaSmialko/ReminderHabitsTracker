...
import com.smialko.reminderhabitstracker.presentation.screens.habits.HabitsPane
import com.smialko.reminderhabitstracker.presentation.screens.listReminderContent.ListScreen
import com.smialko.reminderhabitstracker.presentation.screens.profile.ProfileScreen
...
fun MainScreen(
    ...
    Scaffold(
        ...
        AppNavGraph(
            ...
            habitsScreenContent = { HabitsPane() },
            profileScreenContent = { ProfileScreen(navigationState.navHostController) }
        )
    }
}